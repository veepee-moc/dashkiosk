...
module.exports = function(app) {
    ...
    app.post('/multi-dashboards/:multId(\\d+)', bodyParser.json(), (req, res, next) => {
        db.MultiDashboards.find({ where: { id: req.params.multId } })
            .then(multiDashboard => {
                if (multiDashboard)
                    return multiDashboard.updateAttributes(Object.assign(req.body, { urls: JSON.stringify(req.body.urls) }));
            })
        ...
        db.MultiDashboards.find({ where: { id: req.params.multId } })
            .then(multiDashboard => {
                ...
                res.json({
                    ...
                    urls: JSON.parse(multiDashboard.urls),
