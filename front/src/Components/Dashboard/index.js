    ...
    render() {
        return (
            <li className={`bg-color-transition list-group-item p-0 ${ this.props.dashboard.active ? "active light-blue" : "" }`}>
                <span className="container float-right">
                    <span className="row align-items-center">
                        <a className={`col color-transition ml-1 name ${ this.props.dashboard.active ? "text-white" : "text-dark" }`} href={ this.props.dashboard.url } target="_blank">
